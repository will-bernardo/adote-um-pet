...
export default function MainPageSection2() {
  return (
    <Flex as='section' bg='#f3f4f6' p='4rem 0'>
      <Flex bg='#F5DAC2' gap='7rem' h='26rem' w='100%' justify='center' align='center'>
        <Flex flexDir='column' gap='1rem' w='27rem'>
        ...
        <Flex align='center' justify='center' border='1px' borderColor='#004569' borderRadius='3px' bg='' h='28.5rem' w='27rem' p='0 0.75rem'>
